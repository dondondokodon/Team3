...
void EnemyManager::update(CAMERA camera)
{
	...
	for (auto it = enemies.begin(); it != enemies.end(); )
	{
		...
		{
			//球を打つ
			ProjectileStraight* projectile=new ProjectileStraight(&ProjectileManager::Instance(), Projectile::Faction::enemy, (*it)->getATK(),Projectile::kinds::enemy,1.5f,enemyBullet,VECTOR2{44,66}, VECTOR2{ 1,1 },VECTOR2{8,8});
